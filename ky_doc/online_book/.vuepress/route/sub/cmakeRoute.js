module.exports = [
        {
            title: '如何使用cmake',
            children: [
                {title: 'CMAKE引入', path: '/common/cmake/'},
                {title: 'CMAKE的简单使用', path: '/common/cmake/SimpleUse.md'},
                {title: 'CMAKE组织子模块', path: '/common/cmake/SimpleLib.md'},
                ...
                {title: '如何编写CMAKE的函数以及宏', path: '/common/cmake/FuncAndMarco.md'},
            ]
        }
]
